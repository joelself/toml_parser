...
thread_local!(pub static KEY_VALUE_MAP: RefCell<HashMap<String, HashValue>> = 
	RefCell::new(HashMap::new()));
thread_local!(pub static LAST_TABLE: RefCell<&str> = RefCell::new(""));
...
impl<'a> Parser<'a> {
	pub fn new<'b>() -> Parser<'a> {
		Parser{ root: Toml{ exprs: vec![] }, map: HashMap::new(), leftover: "" }
	}
